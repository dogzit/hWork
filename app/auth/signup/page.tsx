...
export default function SignupPage() {
  ...
  useLayoutEffect(() => {
    ...
    if (storedName) {
      // Хэрэв хэдийн нэвтэрсэн бол бүртгүүлэх шаардлагагүй тул шилжүүлнэ
      ...
      <div className="w-full max-w-sm">
        ...
        <div className="bg-surface-elevated border border-border backdrop-blur-xl rounded-3xl p-8 shadow-2xl">
          <form onSubmit={onSubmit} className="space-y-5">
            ...
            <button
              disabled={loading}
              className="w-full rounded-2xl bg-gradient-to-r from-emerald-600 to-teal-600 py-4 font-black text-white uppercase tracking-widest hover:scale-[1.02] active:scale-[0.98] transition-all flex items-center justify-center gap-2"
            >
              {loading ? (
