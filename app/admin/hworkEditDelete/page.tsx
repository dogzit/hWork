    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100 py-8 px-4">
            ...
            <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-4">
              <div>
                ...
                <p className="mt-2 text-indigo-100">
                  Даалгаврууд нэмэх, засах, устгах
                </p>
              </div>
          ...
          <div className="p-8">
            ...
            {loading ? (
              ...
              <div className="text-center py-12 bg-slate-50 rounded-lg border-2 border-dashed border-slate-200">
                ...
                <p className="mt-4 text-slate-500">Даалгавар олдсонгүй</p>
              </div>
            ) : (
                      ...
                      <div className="flex items-start justify-between gap-6">
                          ...
                          {imgs[0] && (
                            <div className="mt-4">
                              <img
                                ...
                                className="h-48 w-full object-cover rounded-lg cursor-zoom-in border border-slate-200 hover:border-indigo-300 transition-colors"
                              />
                            </div>
                          )}
                        </div>
                        ...
                        <div className="flex shrink-0 items-center gap-2">
                          <button
                            ...
                            className="bg-indigo-50 hover:bg-indigo-100 text-indigo-600 px-4 py-2 rounded-lg font-medium transition-colors flex items-center gap-2"
                          >
                            <svg
                              className="w-4 h-4"
                              fill="none"
      ...
      {editing && (
        ...
        >
          ...
          >
            {/* Модалын толгой */}
            <div className="sticky top-0 bg-gradient-to-r from-indigo-600 to-purple-600 px-8 py-6 flex items-center justify-between border-b border-white/20">
              <div>
